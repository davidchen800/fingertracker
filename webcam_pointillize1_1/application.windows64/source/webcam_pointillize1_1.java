...
public class webcam_pointillize1_1 extends PApplet {
...
Robot robot;
int temp;
int green = color(20, 166, 53);
int purple = color(173, 14, 177);
int count = 0;
...
//      println(temp2.size());
      ...
      robot.mouseMove((int)(1.2f*(1280-new_X)-120), (int)(1.25f*new_Y-55));
    }
...
public void mousePressed() {
  ...
  */
  ...
  //  //  
  //  //  }
  int c = pixels[mouseY*1280+mouseX];
  println(c);
...
public Boolean is_green(int colors) {
  //simply checks if color is close enough to green

  if (diffColor(colors, green) < 100.0f) {
    return true;
  }
  return false;
}
...
public Boolean is_purple(int colors) {
  //simply checks if color is close enough to purple

  if (diffColor(colors, purple) < 100.0f) {
    return true;
  }
  return false;
}
public static double diffColor(int col1, int col2) {
...
public ArrayList findCenter(ArrayList pixel_loc) {
...
public ArrayList green_pixels(int[] pixel_list) {
...
public ArrayList purple_pixels(int[] pixel_list) {
...
//64 135 107
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "webcam_pointillize1_1" };
    if (passedArgs != null) {
